...
@section('title', get_school_info('site_title').' | Fiscal Year Update')
@section('Body')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4">
                <form id="TypeValidation" class="form-horizontal process" action="{{route('fiscal_year.update',[$fiscalyear->id])}}"
                      method="post">
                    @method('PUT')
                    <div class="card ">
                        <div class="card-header card-header-success card-header-text">
                            <div class="card-text col-sm-12">
                                <h4 class="card-title"><center>Edit Fiscal Year</center></h4>
                            </div>
                        </div>
                        <div class="card-body ">
                            <br>
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{$fiscalyear->name}}" type="text"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <label>Fiscal Year Start From (*)</label><br>
                                        <input class="form-control nepali_datepicker" value="{{get_nepali_date($fiscalyear->starting_date)}}" type="text"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control nepali_datepicker" value="{{get_nepali_date($fiscalyear->ending_date)}}" type="text"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" value="{{$fiscalyear->remarks}}" type="text"
