...
@section('title', get_school_info('site_title').' | Edit Journal')
@section('Body')
                    ...
                    <div class="card ">
                        <div class="card-header card-header-success card-header-text">
                            <div class="card-text col-md-12">
                                <h4 class="card-title"><center>Edit Journal No. {{$journal->id}}</center></h4>
                                                    ...
                                                    <div class="col-sm-2">
                                                        <div class="form-group ml-1">
                                                            ...
                                                            <input class="form-control nepali_datepicker" type="text"
                                                                   ...
                                                                   value="{{get_nepali_date($journal->date)}}" required="true"/>
                                                        </div>
                                                    </div>
