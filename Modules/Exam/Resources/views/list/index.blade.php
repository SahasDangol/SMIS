...
@section('title', get_school_info('site_title').' | Exam List')
@section('Body')
    <div class="container-fluid">
        <div class="row">
            @can('exam-create')
                <div class="col-md-4">
                    <form id="TypeValidation" class="form-horizontal process" action="{{URL::to('/exams/list/')}}"
                          method="post">
                        <div class="card ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{ old('final_term_contribution') }}" type="number" step=1 min="1"
