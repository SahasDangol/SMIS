                                ...
                                <div class="text-center">
                                    <div class="col-md-12 ">
                                        <table class="table table-custom" width="100%">
                                            <tbody>
                                            <br>
                                            @if(ucfirst($user->user_type)=="Student")
                                            <tr>
                                            ...
                                            @if($selected->return_date==null)
                                                ...
                                                @foreach($multiple as $singlebook)
                                                    <form id="TypeValidation" class="form-horizontal process" action="{{url('book/submit',[$singlebook->id])}}" method="post"
                                                          enctype="multipart/form-data">
                                                <tr>
                                                    <td class="text-center"><b>Issued Books : </b></td>
                                                    <td>{{$singlebook->books->name}}</td>
                                                    <td></td>
                                                    <td> @if($selected->return_date==null)
                                                            <button class="btn btn-primary btn-round float-right mr-1">
