...
@section('title', get_school_info('site_title').' | Route Detail')
@section('head')
...
@section('Body')
    <div class="container-fluid">
        <div class="row">
            ...
            @can('route-create')
                <div class="col-md-4">
                    <form id="TypeValidation" class="form-horizontal process" action="{{URL::to('/transports/routes/')}}"
                          method="post">
                        <div class="card ">
                            <div class="card-header card-header-success card-header-text">
                                <div class="card-text">
                                    <h4 class="card-title">New Route</h4>
                                </div>
                            </div>
                            <div class="card-body ">
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{ old('route_name') }}" type="text"
                                                   maxlength="100" name="route_name" required="true"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{ old('route_fare') }}" type="text"
                                                   maxlength="15" name="route_fare" required="true"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            <select class="select2" data-size="7" name="vehicle_id"
                                                    data-style="select-with-transition" title="{{old('vehicle_id')}}"
                                                    required="true">
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                            ...
                                            @foreach($routes as $route)
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        @can('route-edit')
                                                            <a href="{{url('/transports/routes/'.$route->route_id.'/edit')}}"
                                                        ...
                                                        @can('route-delete')
                                                            ...
                                                            <form method="post"
                                                                  action="{{route('routes.destroy',$route->route_id)}} "
                                                                  id="delete-form-{{$route->route_id}}">
                                                                @csrf
                                                                {{method_field('DELETE')}}
                                                            </form>
                                                        @endcan
