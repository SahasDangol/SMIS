...
@section('title', get_school_info('site_title').' | Vehicle Update')
@section('Body')
            ...
            @can('vehicle-edit')
                <div class="col-md-4">
                    ...
                    <form id="TypeValidation" class="form-horizontal process"
                          action="{{url('/transports/vehicles/'.$vehicle->vehicle_id)}}" method="POST">
                        @method('PUT')
                        <div class="card ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{$vehicle->vehicle_name}}" type="text"
                                                   name="vehicle_name" required="true"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{$vehicle->serial_number}}" type="text"
                                                   maxlength="15" name="serial_number" required="true"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <select class="select2" data-size="10" name="driver_id"
                                                    data-style="select-with-transition" title="{{old('driver_id')}}"
                                                    required="true">
                                                @foreach($drivers as $driver)
                                                    <option value="{{$driver->staff_id}}"
                                                            @if($driver->staff_id==$vehicle->driver_id)
                                                                selected
                                                            @endif
                                                    >{{$driver->first_name." ".$driver->middle_name." ".$driver->last_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                            ...
                                            @foreach($vehicles as $vehicle)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        @can('vehicle-edit')
                                                            <a href="{{url('/transports/vehicles/'.$vehicle->vehicle_id.'/edit')}}"
                                                        ...
                                                        @can('vehicle-delete')
                                                            ...
                                                            <form method="post"
                                                                  ...
                                                                  id="delete-form-{{$vehicle->vehicle_id}}">
                                                                @csrf
                                                                {{method_field('DELETE')}}
                                                            </form>
                                                        @endcan
