...
@section('title', get_school_info('site_title').' | Designation Update')
            ...
            @can('designation-edit')
                <div class="col-md-4">
                    <form id="TypeValidation" class="form-horizontal process"
                          action="{{URL::to('/designations/'.$designation->id)}}" method="post">
                        @method('PUT')
                        <div class="card ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            <input class="form-control" value="{{$designation->name}}"
