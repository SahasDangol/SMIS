...
@section('title', get_school_info('site_title').' | Add Item')
@section('Body')
    <div class="container-fluid">
        <div class="row">
            @can('item-create')
                <div class="col-md-4">
                    <form id="TypeValidation" class="form-horizontal process" action="{{URL::to('/item/')}}"
                          method="post">
                        <div class="card ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" value="{{ old('current_stock') }}" type="number"
