...
@section('title', get_school_info('site_title').' | New Sale Record')

@section('Body')
    <div class="container-fluid">
        <form id="TypeValidation" class="form-horizontal process" action="{{route('sale.store')}}" method="post"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="material-datatables">
                                                <table id="datatable"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input class="form-control" value="{{old('customer_name')}}"
