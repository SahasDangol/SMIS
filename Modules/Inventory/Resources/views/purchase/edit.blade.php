...
@section('title', get_school_info('site_title').' | Edit Purchase Record')

@section('Body')
    <div class="container-fluid">
        <form id="TypeValidation" class="form-horizontal process" action="{{URL::to('/purchase/'.$purchase->id)}}" method="post"
                    ...
                    <div class="card ">
                        <div class="card-header card-header-success card-header-text">
                            <div class="card-text col-md-12">
                                <h4 class="card-title">
                                    <center>Edit Purchase Record</center>
                                </h4>
                                        ...
                                        <div class="card-body">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <div class="form-group ml-1">
                                                            ...
                                                            <input class="form-control nepali_datepicker" type="text"
                                                                   ...
                                                                   value="{{get_nepali_date($purchase->date)}}"
                                                                   required="true"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="material-datatables">
                                                <table id="datatable"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>Total Amount
                                                            <input class="form-control" readonly id="total_amount"
                                                                   type="text" value="{{$purchase->total_amount}}" name="total_amount"
                                                                   title="Total Amount" required/></th>
                                                        <th>Discount
                                                            <input class="form-control" id="discount"
                                                                   type="text" value="{{$purchase->discount}}" name="discount"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>Final Amount
                                                            <input class="form-control" readonly id="final_amount"
                                                                   type="text" value="{{$purchase->final_amount}}" name="final_amount"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input class="form-control" value="{{$purchase->vendor_name}}"
                                                        ...
                                                        <td>
                                                            <input class="form-control" id="unit" value="{{$purchase->unit_price}}"
                                                                   type="number" step="any" name="unit_price"
                                                                   title="Per Unit Price" required
                                                                   placeholder="Per Unit Price"/>
                                                        </td>
                                                        <td>
                                                            <input class="form-control" id="quantity" value="{{$purchase->quantity}}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" value="{{$purchase->remarks}}"
