...
@section('title', get_school_info('site_title').' | Parents')
@section('head')
    <style>
        table tr {
            cursor: pointer;
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-success card-header-icon">
                        ...
                        <h4 class="card-title">Parent's Report</h4>
                        @can('student-create')
                        ...
                        <div class="material-datatables">
                            <table id="datatables" data-role="table" data-mode="columntoggle" class="ui-responsive"
                                ...
                                <tr>
                                    ...
                                    <th data-priority="2">Father's Name</th>
                                    <th data-priority="3">Mother's Name</th>
                                    <th data-priority="4">Student's Name</th>
                                ...
                                @foreach($parents as $parent)
                                    <tr href="{{url('report/parent/profile/'.$parent->id)}}">
                                        <td>{{$i}}</td>
                                        <?php  $i++;
                                        ?>
                                        ...
                                        <td>{{ucfirst($parent->first_name)}} {{ucfirst($parent->middle_name)}} {{ucfirst($parent->last_name)}}</td>

                                        <td class="text-right">
                                            @can('student-list')
                                                <a href="{{url('report/parent/profile/'.$parent->id)}}"
