...
@section('title', get_school_info('site_title').' | Import Human Resources Details')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="card card-pricing ">
                            ...
                            <div class="card-footer justify-content-center ">
                                <a href="{{ asset('hr.xlsx') }}" class="btn btn-round btn-rose">Download</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal fade modal-mini modal-primary" id="myModal10" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-small">
                    <div class="modal-content">
                        ...
                        <form action="{{url('hr/import')}}" class="process" method="post" enctype="multipart/form-data">
