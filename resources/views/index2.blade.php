...
<!-- Mirrored from demos.creative-tim.com/now-ui-kit-pro/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Jan 2019 08:55:28 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="{{url('assets/frontend/img/apple-icon.png')}}">
    <link rel="icon" type="image/png" href="{{url('assets/frontend/img/favicon.png')}}">
    ...
    <link href="{{url('use.fontawesome.com/releases/v5.0.6/css/all.css')}}" rel="stylesheet">
    ...
    <link href="{{url('assets/frontend/css/now-ui-kit.mincdae.css?v=1.2.2')}}" rel="stylesheet" />
    ...
    <link href="{{url('assets/frontend/demo/demo.css')}}" rel="stylesheet" />
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" data-nav-image="./assets/img//blurred-image-1.jpg" data-color="orange">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-primary" href="{{url('/register')}}" target="_blank">
                        <p>Register</p>
                    </a>
                </li>
...
<div class="wrapper"><div class="page-header clear-filter" filter-color="orange">
        ...
        <div class="rellax-header rellax-header-buildings" data-rellax-speed="0">
            <div class="page-header-image page-header-city"  style="background-image: url('assets/frontend/img/presentation-page/nuk-pro-buildings.png')">
            </div>
        </div>

        <div class="rellax-text-container">
            <h1 class="h1-seo rellax-text" data-rellax-speed="-1">Turing Soft</h1>
        </div>

        <h3 class="h3-description rellax-text" data-rellax-speed="-1">Only I can change my life. No one can do it for me.</h3>

        <h6 class="category category-absolute rellax-text" data-rellax-speed="-1">Property Of Turing Soft</h6>
    ...
    <div class="main">
        ...
        <div class="section section-basic" id="basic-elements">
            <div class="container">
                ...
                <!--                 end social buttons --><div class="space-70"></div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-8 col-sm-5">
                                    <select class="select2" data-size="7" data-style="btn btn-primary btn-round btn-block" title="Single Select">
                                ...
                                <div class="col-lg-6 col-md-8 col-sm-5">
                                    <select class="select2" data-style="btn btn-info btn-round btn-block" multiple title="Choose City" data-size="7">
        ...
        <!-- End Section Tabs --><div class="section section-pills">
            <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        </div><div class="progress-container progress-danger">
                    ...
                    <div class="col-md-6">
                        ...
                        </ul><div class="pagination-container justify-content-center">
                            <ul class="pagination pagination-primary">
        ...
        </div><!--  end notifications --><div class="section section-pre-footer" data-background-color="gray">
            ...
            <div id="footer-areas">
                ...
                <footer class="footer">
                    <div class="container">
                        ...
                        <div class="copyright">
                            &copy; <script>document.write(new Date().getFullYear())</script>, Designed by <a href="http://www.invisionapp.com/" target="_blank" class="copyright-link">Invision</a>. Coded by <a href="https://www.creative-tim.com/" target="_blank" class="copyright-link">Creative Tim</a>.
                        </div>
                    </div>
                </footer>
        ...
        <div class="section">
            ...
            <div class="container">
                ...
                <div id="contentAreas" class="cd-section">
                    ...
                    <div id="tables">
                        <div class="title">
                            <h3><small>Tables</small></h3>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <h4><small>Simple Table</small></h4>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-8 ml-auto mr-auto">
                                <div class="media-area">
                                    <h3 class="title text-center"><small>10 Comments</small></h3>
                                    <div class="media">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <h5 class="media-heading">Tina Andrew <small class="text-muted">&middot; 2 Days Ago</small></h5>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="media-heading">Rosa Thompson <small class="text-muted">&middot; 2 Days Ago</small></h5>
                                ...
                                <h4 class="text-center">Post your comment <br><small class="text-muted">- Logged In User -</small></h4>
                                <div class="media media-post">
                                    <a class="pull-left author" href="#pablo">
                                        <div class="avatar">
                                            <img class="media-object img-raised" alt="64x64" src="assets/img/james.jpg">
                                ...
                                <h4 class="text-center">Post your comment <br><small class="text-muted">- Not Logged In User -</small></h4>
                                <div class="media media-post">
                                    <a class="pull-left author" href="#pablo">
                                        <div class="avatar">
        ...
        </div><div id="cards" class="section section-cards" data-background-color="gray">
            <!--     *********    BLOG CARDS     *********      -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 px-0">
                        <div class="card-container">
                            ...
                            <div class="card card-fashion card-background" style="background-image: url('../../mvpwp.com/demo/nowwp/wp-content/uploads/sites/6/2017/06/a-james-donovan-180375.jpg')">
            ...
            <!--     *********    END PRICING CARDS      *********      -->
        </div><div class="section section-plain-cards">
    ...
    <script src="assets/frontend/js/plugins/bootstrap-tagsinput.js"></script>
    <!--	Plugin for Select, full documentation here: http://silviomoreto.github.io/bootstrap-select -->
    <script src="assets/frontend/js/plugins/bootstrap-selectpicker.js" type="text/javascript"></script>
    ...
    <!-- Control Center for Now Ui Kit: parallax effects, scripts for the example pages etc --><script src="assets/js/now-ui-kit.mincdae.js?v=1.2.2" type="text/javascript"></script>
    <!-- Sharrre libray -->
...
<!-- Mirrored from demos.creative-tim.com/now-ui-kit-pro/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 23 Jan 2019 08:57:09 GMT -->
</html>
